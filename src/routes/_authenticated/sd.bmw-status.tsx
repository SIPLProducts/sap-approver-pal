...
const BP_COLS: ColDef[] = [
  ...
  { key: "BP_REGISTRATION_DATE", label: "Reg. Date", type: "date", group: "bp" },
  { key: "BP_UPPER_SLAB", label: "Upper Slab", type: "decimal3", group: "bp" },
  { key: "BP_NO_BEDS_INVOICED", label: "Beds to Invoice", type: "int", group: "bp" },
  { key: "BP_AGREEMENT_VALID_FROM", label: "Agr. Valid From", type: "date", group: "bp" },
  { key: "BP_AGREEMENT_VALID_TO", label: "Agr. Valid To", type: "date", group: "bp" },
...
const CONTRACT_COLS: ColDef[] = [
  ...
  { key: "CONT_CREATION_DATE", label: "Create Date", type: "date", group: "contract" },
  { key: "CONT_CREATED_BY", label: "Created By", type: "text", group: "contract" },
  ...
  { key: "CON_SERVICE_VALID_FROM", label: "Con Srv Valid From", type: "date", group: "contract" },
  { key: "CON_SERVICE_VALID_TO", label: "Con Srv Valid To", type: "date", group: "contract" },
  { key: "CON_SERVICE_START_DATE", label: "Con Srv Start", type: "date", group: "contract" },
  { key: "CON_REGISTRATION_DATE", label: "Con Reg. Date", type: "date", group: "contract" },
  { key: "CON_UPPER_SLAB", label: "Con Upper Slab", type: "decimal3", group: "contract" },
  { key: "CON_NO_BEDS_INVOICED", label: "Con Beds to Invoice", type: "int", group: "contract" },
  { key: "CON_AGREEMENT_VALID_FROM", label: "Con Agr. Valid From", type: "date", group: "contract" },
  { key: "CON_AGREEMENT_VALID_TO", label: "Con Agr. Valid To", type: "date", group: "contract" },
